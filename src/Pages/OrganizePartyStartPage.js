...
class OrganizePartyStartPage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            eventNme: '',
    ...
    async validateForm() {
        ...
        if (result) {
            ...
            if (this.props.route.hasOwnProperty('params') &&
                ...
                this.props.route.params.updateText('partyCreated'); // it call api on DiscoverDash
            }
        }
    }
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', }}>
                                    <TouchableOpacity style={{
                                        ...
                                        {this.state.OpenDateDialogModal == false && (this.state.startDate !== '')
                                            ...
                                            <Text style={[CommonStyles.userButtonInput_Black, { paddingLeft: 10, color: Colors.midGray }]}>
                                                Start date</Text>}
                                    </TouchableOpacity>
